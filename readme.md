# RDS Spy compatibility with the TEF Tuners (COM Ports)
- RDS Spy should be fully compatible with the TEF over TCP (port 7373, default COM Port is 3, change COM in code (line 6) to connect to your TEF if needed.)
